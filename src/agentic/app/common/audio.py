...
class AudioProcessor:
    def __init__(self, agentic_config: AgenticConfig):
        self.tts_processor, self.tts_model, self.tts_vocoder, self.female_speaker_embedding = get_text_to_speech_pipeline()
    ...
    async def text_to_speech(self, text: str) -> str:
        ...
        speech = self.tts_model.generate_speech(inputs["input_ids"], self.female_speaker_embedding, vocoder=self.tts_vocoder)
